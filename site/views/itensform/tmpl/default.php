...
<script type="text/javascript">
    ...
    getScript('//ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js',function() {
        ...
        js(document).ready(function(){
            js('#form-itens').submit(function(event){
...
<div class="itens-edit front-end-edit">
    ...
    <form id="form-itens" action="<?php echo JRoute::_('index.php?option=com_videos&task=itens.save'); ?>" method="post" class="form-validate" enctype="multipart/form-data">
        <ul>
			...
			<div class="control-group">
				<?php $canState = false; ?>
				<?php if($this->item->id): ?>
					<?php $canState = $canState = JFactory::getUser()->authorise('core.edit.state','com_videos.itens'); ?>
				<?php else: ?>
					<?php $canState = JFactory::getUser()->authorise('core.edit.state','com_videos.itens.'.$this->item->id); ?>
			...
			<div class="control-group">
				...
				<div class="fltlft" <?php if (!JFactory::getUser()->authorise('core.admin','videos')): ?> style="display:none;" <?php endif; ?> >
                ...
                <script type="text/javascript">
                    ...
                    jQuery('.tab-pane select').each(function(){
                       ...
                       document.getElementById("form-itens").appendChild(input);
                    });
                </script>
             <?php endif; ?>
        </ul>
        ...
        <div>
            ...
            <?php echo JText::_('or'); ?>
            <a href="<?php echo JRoute::_('index.php?option=com_videos&task=itensform.cancel'); ?>" title="<?php echo JText::_('JCANCEL'); ?>"><?php echo JText::_('JCANCEL'); ?></a>

            <input type="hidden" name="option" value="com_videos" />
            <input type="hidden" name="task" value="itensform.save" />
